...
TEST(TestUnscentedKalmanFilter, CtrvPrediction)
{
  ...
  const cp::CtrvStateCovariance covariance{
  ...
  const cp::CtrvStateCovariance expected_covariance{
    {0.0650073, -0.0670999, 0.00564003, -0.0463523, -0.0240175},
...
TEST(TestUnscentedKalmanFilter, CtraPrediction)
{
  ...
  const cp::CtraStateCovariance covariance{{0.0043, -0.0013, 0.0030, -0.0022, -0.0020, 0.5},
  ...
  const cp::CtraStateCovariance expected_covariance{
    {39.64316, 34.85464, 106.24644, -0.06485, -0.03496, 106.36900},
