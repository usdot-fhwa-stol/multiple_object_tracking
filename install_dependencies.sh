...
apt update
DEBIAN_FRONTEND=noninteractive apt install -y --no-install-recommends libboost-container-dev nlohmann-json3-dev libgtest-dev libgmock-dev libpng-dev libjpeg-dev libopenblas-dev
